...
export const addInvoicesFromDataBase = async (
  ...
  try {
    const response = await axios.post(baseURL + "/factura/post", invoice);
    return response.data;
  } catch (error) {
...
export const editInvoiceFromDataBase = async (invoice: Invoice) => {
  try {
    const response = await axios.put(baseURL+ "/factura/put", invoice);
    return response.data;
  } catch (error) {
...
export const addInvoiceProductFromDataBase = async (productInvoice: ProductInvoice, InvoiceId: number) => {
  try {
    const response = await axios.put(baseURL + "/factura/post/product", {productInvoice,InvoiceId } );
    return response.data;
  } catch (error) {
    console.error("Error en editInvoices:", error);
    throw error;
...
export const editInvoiceProductFromDataBase = async (productInvoice: ProductInvoice, InvoiceId: number) => {
  try {
    const response = await axios.put(baseURL + "/factura/put/product", {productInvoice,InvoiceId } );
    return response.data;
  } catch (error) {
    console.error("Error en editInvoices:", error);
    throw error;
...
export const removeInvoiceProductFromDataBase = async (productId: number, InvoiceId: number) => {
  try {
    const response = await axios.delete(`${baseURL}/factura/put/product?productId=${productId}&InvoiceId=${InvoiceId}`);
    return response.data;
  } catch (error) {
    console.error("Error en editInvoices:", error);
    throw error;
...
export const removeInvoiceFromDataBase = async ( InvoiceId: number) => {
  try {
    const response = await axios.delete(baseURL+"/factura/delete", { params: { InvoiceId } });
    return response.data;
  } catch (error) {
    console.error("Error en editInvoices:", error);
    throw error;
